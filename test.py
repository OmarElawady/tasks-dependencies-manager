...
def test_normal_commands(normal_task_list):
    result = normal_task_list.print_out_to_string("a")
    tree = {"a": ["b", "c"],
            "b": ["d"],
            "c": [],
            "d": []}
...
def test_cyclic_commands(cyclic_task_list):
    result = cyclic_task_list.print_out_to_string("a")
    cycle = ["a", "b", "d"]
